...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section">
      ...
      <div className="max-w-3xl mx-auto glass-card p-10 md:p-16 text-center fade-up relative overflow-hidden group">
        {/* Glowing aura */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 rounded-full bg-red-600/5 blur-3xl pointer-events-none" />
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          ...
          <a
            ...
            className="w-full sm:w-auto px-8 py-4 border border-white/10 rounded-2xl hover:border-red-500/50 hover:bg-red-500/5 text-slate-300 hover:text-white transition-all duration-300 flex items-center justify-center gap-2"
          >
